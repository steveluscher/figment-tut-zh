...
> 原文：[Figment Tutorials](https://learn.figment.io/tutorials)
> 
...
* [在线阅读](https://figment.apachecn.org)
...
*   在我们的 [apachecn/figment-tut-zh](https://github.com/apachecn/figment-tut-zh) github 上提 issue.
...
```
docker pull apachecn0/figment-tut-zh
docker run -tid -p <port>:80 apachecn0/figment-tut-zh
