...
> 原文:[https://github . com/fig ment-networks/learn-tutorials/blob/master/polygon/ERC 20-pos-bridge-SDK . MD](https://github.com/figment-networks/learn-tutorials/blob/master/polygon/erc20-pos-bridge-sdk.md)
...
[![mumbai](../Images/8fdcebcad17deab512877e12b4954ede.png)T2】](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-mumbai.png)
...
*   选择**戈里测试网- >孟买测试网**
    ...
    [![map image](../Images/969cd9dc207e36e8db7c16d624876a24.png)T2】](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-map.png)

*   此时，映射过程不会立即进行，可能需要 3 天才能得到确认。

然后打开 [mapper.matic.today](https://mapper.matic.today/) ，输入合同地址，看是否已经添加。

[![mapped image](../Images/f9e22ec1796d2903e2dfb3d8cd046f99.png)T2】](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-mapped.png)
...
[![metamask after map](../Images/2e9cf94a4a130f5456f7b44a1916e5e8.png)T2】](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-metamask-after-map.png)
...
[![MLB Metamask](../Images/f71fc0cf645347c00c0598cc29b1af5c.png)T2】](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-MLB-token.png)
...
2.  确保在元掩码中选择了以太坊主网
    ...
    [![Metamask Ethereum](../Images/f9f5d84a3aa75edd54b46b6d57c77129.png)T2】](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-metamask-eth-mainnet.png)

3.  点击**元掩码**。首次登录选项

4.  您将被要求签署一份**签名请求**，以确保您有权使用钱包。这是免费的

    [![pos web ui login](../Images/222adca40b5d25149e705a1fde95f8a4.png)T2】](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-web-ui-login.png)

5.  我选择了以太坊的`DAI`令牌

    [![DAI](../Images/15f2ac3daf501a6a227dcbcfd875ae94.png)T2】](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-web-ui-dai.png)

6.  点击**传送**

7.  然后查看交易细节，如汽油费和你发送代币的智能合同，然后点击**确认**

    [![transfer](../Images/fa2b0e933de5335907cee797111c3b56.png)T2】](https://github.com/figment-networks/learn-tutorials/raw/master/assets/erc20-pos-web-ui-transfer.png)
