...
> 原文:[https://github . com/fig ment-networks/learn-tutorials/blob/master/avalanche/using-truffle-with-the-avalanche-c-chain . MD](https://github.com/figment-networks/learn-tutorials/blob/master/avalanche/using-truffle-with-the-avalanche-c-chain.md)
