# avalanche/deploy-pangolin-to-local-testnet-with-token-pair

> 原文：<https://github.com/figment-networks/learn-tutorials/blob/master/avalanche/deploy-pangolin-to-local-testnet-with-token-pair.md>
...
![](img/bf10f84c76586e5ce7eaf185362aa3d0.png)
