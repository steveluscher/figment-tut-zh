...
让我们一起深入了解 Solana web3js。`Web3js`提供一套完整的调用，让我们能够获得链上数据。你可以更深入地阅读[文档](https://solana-labs.github.io/solana-web3.js/v1.x/)创建一个名为`SupplyCard`的新文件夹，里面有一个索引文件:`src/components/SupplyCard.tsx/index.tsx`。
