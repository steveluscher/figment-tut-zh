...
> 原文:[https://github . com/fig ment-networks/learn-tutorials/blob/master/cosmos/build-a-polling-app . MD](https://github.com/figment-networks/learn-tutorials/blob/master/cosmos/build-a-polling-app.md)
